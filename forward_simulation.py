...
L_mesh = BigFileMesh('pairedICs'+str(paired)+'.bigfile', dataset='Field')
NL_mesh = BigFileMesh('NL_mesh'+str(paired)+'.bigfile', dataset='Field')

Nc = NL_mesh.attrs['Nmesh'][0]
Length = NL_mesh.attrs['BoxSize'][0] # Mpc  h-1
zobs = 0.3
